...
//  https://github.com/BANKEX/secp256k1_swift/blob/master/Classes/secp256k1.swift
//
...
//
//
//  Edited By Vergil Choi on 12.01.2019
//
//  Changed signature format to (recid + 31) + 64 bytes
//
...
extension SECP256K1 {
    ...
    public static func parseSignature(signature: Data) -> secp256k1_ecdsa_recoverable_signature? {
        ...
        let serializedSignature = Data(signature[1...64])
        let v = Int32(signature[0]) - 31
    ...
    internal static func serializeSignature(recoverableSignature: inout secp256k1_ecdsa_recoverable_signature) -> Data? {
        ...
        return Data([31 + UInt8(v)]) + Data(serializedSignature)
    }
